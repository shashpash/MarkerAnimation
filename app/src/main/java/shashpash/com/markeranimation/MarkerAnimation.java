package shashpash.com.markeranimation;
...
public class MarkerAnimation {
    ...
    public static void updateMarker(Marker marker, LatLng newLocaiton) {
        if (marker != null) {
//            val prevLoc = Location("gps")
//            prevLoc.latitude = marker.position.latitude
//            prevLoc.longitude = marker.position.longitude
    ...
    static void animateMarkerToICS(Marker marker, LatLng finalPosition, final LatLngInterpolator latLngInterpolator) {
        ...
        ObjectAnimator animator = ObjectAnimator.ofObject(marker, Property.of(Marker.class, LatLng.class, "position"), typeEvaluator, finalPosition);
...
//            float startRotation = marker.getRotation();
    ...
    public static void fadeInMarker(Context context, final Marker marker, boolean isIn) {
        ...
        ValueAnimator ani = ValueAnimator.ofFloat((float) from, (float) to);
        ani.setDuration(500);
